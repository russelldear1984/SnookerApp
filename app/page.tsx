  ...
  return (
    <AppShell title="Gamlingay Snooker Club App">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        <Link
          href="/schedule"
          className="rounded-2xl bg-gradient-to-r from-emerald-600 to-green-600 p-6 text-center text-2xl font-bold text-white shadow-[0_10px_26px_rgba(5,150,105,0.35)]"
        >
          Book Table
        </Link>
